...
<html>
    <head>
        ...
        <script><%@include file="/WEB-INF/lib/scripts/scriptsCheckingEnrollmentForm.jsp"%></script>
    </head>
        ...
        <div class="_header">
            ...
            <div class="_nav">
                <nav>
                    ...
                    <a class="_nav_link" href="faculties">
                        <c:choose>
                            <c:when test="${\"ADMIN\".equals(status)}"> ${stats}</c:when>
                            <c:otherwise>${fac}</c:otherwise>
                        </c:choose></a>
            ...
            <c:otherwise>
                <div class="user_info">
                    <c:if test="${user.getRole().equals(\"STUDENT\") && !user.getStatus().equals(\"UNDEFINED\")}">
                        ...
                        <label>${fac}: ${user.getFaculty()}</label><br><br>
