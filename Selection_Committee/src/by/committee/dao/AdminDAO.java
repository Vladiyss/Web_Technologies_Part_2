    ...
    private void setStudentCount() {
        try (Connection connection = ConnectionPool.getInstance().connect();
            ...
            while (set.next()) {
                ...
                if (count < course.getBudgetPlacesAmount() + course.getFeePlacesAmount()) {
                	course.setTotalStudentCount(count);
                }
                else {
                	course.setTotalStudentCount(course.getBudgetPlacesAmount() + course.getFeePlacesAmount());
                }
