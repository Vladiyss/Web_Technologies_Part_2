...
import by.committee.beans.User;
...
public class UserDAO {
    ...
    private String ENTRANT_BY_HASH_QUERY = "SELECT    iduser," + "       login,\n" + "       name,\n" + "       surname,\n" +  "       role,\n" +
    ...
    public Participant getRegisteredUser(String login, String hashPassword) {
    ...
    public Participant getUserByHash(String hash, boolean entrant) {
        String query;
        Participant user = null;
        if (entrant) {
    ...
    public Participant registerUser(User unregUser, String password) {
        try(Connection conn = ConnectionPool.getInstance().connect()) {
