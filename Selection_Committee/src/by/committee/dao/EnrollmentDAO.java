...
public class EnrollmentDAO {
    ...
    private String ENTRANTS_COURSE_AND_CERTIFICATE_SET_QUERY ="UPDATE entrant SET enrollment_status='ENROLLING',course_idcourse=?,"
    		+ " certificate_score=?, total_score=? WHERE identrant=?;";
    
    private String COURSE_SELECT_QUERY = "WITH CourseInfo AS (\n" +
                    ...
                    "       enrollment_plan_fee,\n" + "       subjects,\n" + "       subject_id,\n" +
                    "       GROUP_CONCAT(faculty.name) as faculty\n" + "FROM CourseInfo JOIN faculty\n" +
                    "                   ON faculty.idfaculty = CourseInfo.faculty_idfaculty\n" + "GROUP BY CourseInfo.idcourse;";
