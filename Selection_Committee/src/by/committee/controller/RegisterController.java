...
import static by.committee.service.Utilities.hash;
...
public class RegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        User user= new User(request.getParameter("name"), request.getParameter("surname"), request.getParameter("login") );
        ...
        if(user != null) {
            ...
            request.getRequestDispatcher("/WEB-INF/lib/register.jsp").forward(request, response);
        }
    }
